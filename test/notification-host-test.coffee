...
describe 'HOST notification', ->
  ...
  it 'interpolates notificationIndex correctly', ->
    ...
    properValue = ':nagios_status_ok_green: Mon 08:30:03 UTC [1000] [irc] HOST reviewboard1.webapp.scl3.mozilla.com is PING OK - Packet loss = 0%, RTA = 0.92 
ms'
    ...
    n = new notification.Notification(line)
    n.parse(line)
    properValue = ':nagios_status_ok_green: Mon 08:30:03 UTC [1000] [irc] HOST reviewboard1.webapp.scl3.mozilla.com is PING OK - Packet loss = 0%, RTA = 0.92 ms'
    expect(msg).to.equal(properValue)
